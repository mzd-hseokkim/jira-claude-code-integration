...
describe('getStepState', () => {
  ...
  // U12
  it('U12 — 비순차: approach는 completedSteps에 있으면 done', () => {
  ...
  // U14 — 회귀 방어
  it('U14 — SDLC_STEPS에 init이 포함되지 않고 plan/design은 approach로 통합됨', () => {
