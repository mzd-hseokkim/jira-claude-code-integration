...
```bash
# 1. 플러그인 설치 (Setup 참고)
claude plugin add /path/to/jira-claude-code-integration
...
# 또는 마켓플레이스에서 설치 (등록된 경우)
claude plugin add jira-integration@<marketplace>
```

설치 후 `/jira`를 입력하면 플러그인이 로드되었는지 확인할 수 있습니다.
